...
export const escapeGamesData: EscapeGameData[] = [
  ...
  },
  {
    ...
    infos: [
      ...
      { icon: '🌐', label: { en: 'Languages', fr: 'Langues', es: 'Idiomas', de: 'Sprachen', it: 'Lingue' }, value: { en: 'FR · EN · ES', fr: 'FR · EN · ES', es: 'FR · EN · ES', de: 'FR · EN · ES', it: 'FR · EN · ES' }, sub: { en: 'Others on request', fr: 'Autres sur demande', es: 'Otros bajo petición', de: 'Andere auf Anfrage', it: 'Altre su richiesta' } },
